...
class ListenerConfig:
    def __init__(self, **kwargs):
        ...
        self.mastodon_s3_bucket_name = kwargs.get(
            "mastodon_s3_bucket_name", None)
        self.mastodon_s3_bucket_prefix_path = kwargs.get(
            "mastodon_s3_bucket_prefix_path", "/")
        self.mastodon_s3_access_key_id = kwargs.get(
            "mastodon_s3_access_key_id", None)
        self.mastodon_s3_access_secret_key = kwargs.get(
            "mastodon_s3_access_secret_key", None)
        self.aws_polly_region_name = kwargs.get(
            "aws_polly_region_name", "us-east-1")
        ...
        self.postgres_database = kwargs.get("postgres_database", None)
        self.embedding_space_name = kwargs.get("embedding_space_name", None)
        self.embedding_intro_content = kwargs.get(
            "embedding_intro_content", None)
        self.embedding_model = kwargs.get("embedding_model", None)
        self.embedding_token_budget = kwargs.get(
            "embedding_token_budget", None)
        self.embedding_match_threshold = kwargs.get(
            "embedding_match_threshold", None)
        self.embedding_match_count = kwargs.get("embedding_match_count", None)
    ...
    def set_postgres_host(self, postgres_host):
        self.postgres_host = postgres_host

    def get_postgres_port(self):
        return self.postgres_port

    def set_postgres_port(self, postgres_port):
        self.postgres_port = postgres_port

    def get_postgres_user(self):
        return self.postgres_user

    def set_postgres_user(self, postgres_user):
        self.postgres_user = postgres_user

    def get_postgres_password(self):
        return self.postgres_password

    def set_postgres_password(self, postgres_password):
        self.postgres_password = postgres_password

    def get_postgres_database(self):
        return self.postgres_database

    def set_postgres_database(self, postgres_database):
        self.postgres_database = postgres_database

    def get_embedding_space_name(self):
        return self.embedding_space_name

    def set_embedding_space_name(self, embedding_space_name):
        self.embedding_space_name = embedding_space_name

    def get_embedding_intro_content(self):
        return self.embedding_intro_content

    def set_embedding_intro_content(self, embedding_intro_content):
        self.embedding_intro_content = embedding_intro_content
    ...
    def get_embedding_token_budget(self):
        return self.embedding_token_budget

    def set_embedding_token_budget(self, embedding_token_budget):
        self.embedding_token_budget = embedding_token_budget

    def get_embedding_match_threshold(self):
        return self.embedding_match_threshold

    def set_embedding_match_threshold(self, embedding_match_threshold):
        self.embedding_match_threshold = embedding_match_threshold

    def get_embedding_match_count(self):
        return self.embedding_match_count

    def set_embedding_match_count(self, embedding_match_count):
        self.embedding_match_count = embedding_match_count
